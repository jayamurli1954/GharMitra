...
# ✅ **Acceptance Criteria — 6-01-08-022**
...
Then the field **“Expense For Month” (YYYY-MM)** must be present
...
## **3️⃣ Maintenance Bill Generation**
...
> “Select the month in which this service was used, even if paid later.”
...
> “Please select the month this expense belongs to.”

---

## **7️⃣ Reports Consistency**
...
# 🏆 This CR is considered **SUCCESSFUL** only if:

| Test                                                        | Result |
| ----------------------------------------------------------- | ------ |
| December expenses paid in January appear in December bill   | ✅      |
| Bank shows January payment                                  | ✅      |
| December P&L shows expense                                  | ✅      |
| January P&L does not show it                                | ✅      |
| User can understand the screen without accounting knowledge | ✅      |
